...
contract StarNotary is ERC721 {
    ...
    string public name = "My Sunday Token";
    string public symbol = "MSUT";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(
            ...
            "ERC721: caller is not owner of either star"
        );
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(
            msg.sender == owner,
            "ERC721: caller is not owner of star"
        );
